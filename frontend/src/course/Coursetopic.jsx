            ...
            {(loader ? <section className=" flex justify-center h-[75vh] items-center" ><BarLoader size={50} color='green' /></section> :
                <div>
                    <div className=' flex p-2 min-[760px]:h-[28vh] justify-center shadow-lg'>
                        ...
                        {
                            data?.map((item, index) => {
                                return <div className='w-[100%] sm:w-[65%] sm:p-2' key={index}>
                                    <h1 className='text-xl sm:text-3xl text-green-600 font-bold'>{item.name}</h1>
                            ...
                            </thead>
                            {
                                topic?.map((item, index) => {
                                    return <tr className=' hover:bg-[#edf1d6] border-b border-slate-500' key={index}>
                                        ...
                                        <td className=' p-3 font-semibold text-left'>{(item.id == topictrack[item.id] ? <section className=" flex items-center"><buttton className=" font-bold">Complete</buttton> <IoMdCheckmarkCircle size={20} className=' mx-1 text-green-600' /> </section>
